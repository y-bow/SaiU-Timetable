...
import { buildYearMap } from '../data/schools.js?v=2026-09-06-002';
import { parseTeacherGrid } from '../data/parser.js?v=2026-09-06-002';
import { resolveCourse } from '../data/course-normalizer.js?v=2026-09-06-002';
import { buildTeacherIndex } from '../data/teacher-index.js?v=2026-09-06-002';
import { syncYear2Labs } from './lab-fetch.js?v=2026-09-06-002';
...
export function gatherAllTimetables(mainText, labClasses = [], yearMap = buildYearMap()) {
    ...
    for (const c of labClasses || []) {
        const label = c.school
            ...
            : `${schoolLabel({ id: 'scds' })} · Year 2 Lab`;
