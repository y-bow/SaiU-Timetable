...
import { buildYearMap } from '../data/schools.js?v=2026-09-07-001';
import { parseTeacherGrid } from '../data/parser.js?v=2026-09-07-001';
import { resolveCourse } from '../data/course-normalizer.js?v=2026-09-07-001';
import { buildTeacherIndex } from '../data/teacher-index.js?v=2026-09-07-001';
import { syncYear2Labs } from './lab-fetch.js?v=2026-09-07-001';
