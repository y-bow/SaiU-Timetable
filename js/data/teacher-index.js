...
import { normalizeFacultyName } from './parser.js?v=2026-09-12-001';
import { classIdentity, flattenClasses } from './change-detector.js?v=2026-09-12-001';
import {
    buildIdentityResolution,
    loadTeacherConfirmations,
    teacherSearchText,
} from './teacher-identity.js?v=2026-09-12-001';
