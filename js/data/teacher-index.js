...
import { normalizeFacultyName } from './parser.js?v=2026-08-21-005';
import { classIdentity, flattenClasses } from './change-detector.js?v=2026-08-21-005';
import {
    buildIdentityResolution,
    loadTeacherConfirmations,
    teacherSearchText,
} from './teacher-identity.js?v=2026-08-21-005';
