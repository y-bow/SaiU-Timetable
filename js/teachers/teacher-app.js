...
import { loadTeacherIndex } from '../services/teacher-fetch.js?v=2026-08-30-005';
import { CONFIG } from '../core/config.js?v=2026-08-30-005';
import { initAiAssistant } from '../ui/ai-assistant.js?v=2026-08-30-005';
import { toMinutes, minutesToLabel, minutesToClock, todayName, WEEKDAYS, labSubjectLabel } from '../core/utils.js?v=2026-08-30-005';
import { confirmTeacherMerge, dismissTeacherMerge } from '../data/teacher-identity.js?v=2026-08-30-005';
