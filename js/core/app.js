import { CONFIG } from './config.js?v=2026-08-18-001';
import { parseCSV, parseRoomOccupancy, offeringKey } from '../data/parser.js?v=2026-08-18-001';
import { compareTimetables, classIdentity, setChangeDetectorDebug } from '../data/change-detector.js?v=2026-08-18-001';
import { getSection as getStoredSection, setSection as setStoredSection, hasSeenSectionModal, markSectionModalSeen } from '../services/storage.js?v=2026-08-18-001';
import * as nav from '../ui/navigation.js?v=2026-08-18-001';
import * as ui from '../ui/ui.js?v=2026-08-18-001';
import { checkArjunSinghTransition, resetArjunSinghTransition } from '../ui/easter-eggs.js?v=2026-08-18-001';
import * as labSection from '../ui/lab-section.js?v=2026-08-18-001';
import { loadMergedYear2Timetable } from '../services/lab-fetch.js?v=2026-08-18-001';
import { matchesEmergingToolsSection } from '../data/lab-parser.js?v=2026-08-18-001';
import { todayName, nowMinutes, nextSchoolDay, isSchoolDay } from './utils.js?v=2026-08-18-001';
import { init as initAnalytics, trackEvent } from '../services/analytics.js?v=2026-08-18-001';
import { dispatchTimetableChanges, setN8nDebug } from '../services/n8n.js?v=2026-08-18-001';
...
import '../services/timetable-test-harness.js?v=2026-08-18-001';
import { initAiAssistant } from '../ui/ai-assistant.js?v=2026-08-18-001';
import { initFreeRooms } from '../ui/free-rooms.js?v=2026-08-18-001';
