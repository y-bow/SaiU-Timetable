import { CONFIG } from './config.js?v=2026-08-13-004';
import { parseCSV, offeringKey } from '../data/parser.js?v=2026-08-13-004';
import { compareTimetables, classIdentity, setChangeDetectorDebug } from '../data/change-detector.js?v=2026-08-13-004';
import { getSection as getStoredSection, setSection as setStoredSection, hasSeenSectionModal, markSectionModalSeen } from '../services/storage.js?v=2026-08-13-004';
import * as nav from '../ui/navigation.js?v=2026-08-13-004';
import * as ui from '../ui/ui.js?v=2026-08-13-004';
import { checkArjunSinghTransition } from '../ui/easter-eggs.js?v=2026-08-13-004';
import * as labSection from '../ui/lab-section.js?v=2026-08-13-004';
import { loadMergedYear2Timetable } from '../services/lab-fetch.js?v=2026-08-13-004';
import { matchesEmergingToolsSection } from '../data/lab-parser.js?v=2026-08-13-004';
import { todayName, nowMinutes, nextSchoolDay, isSchoolDay } from './utils.js?v=2026-08-13-004';
import { init as initAnalytics, trackEvent } from '../services/analytics.js?v=2026-08-13-004';
import { dispatchTimetableChanges, setN8nDebug } from '../services/n8n.js?v=2026-08-13-004';
...
import '../services/timetable-test-harness.js?v=2026-08-13-004';
