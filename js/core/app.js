import { CONFIG } from './config.js?v=2026-08-13-005';
import { parseCSV, offeringKey } from '../data/parser.js?v=2026-08-13-005';
import { compareTimetables, classIdentity, setChangeDetectorDebug } from '../data/change-detector.js?v=2026-08-13-005';
...
import { todayName, nowMinutes, nextSchoolDay, isSchoolDay } from './utils.js?v=2026-08-13-005';
import { init as initAnalytics, trackEvent } from '../services/analytics.js?v=2026-08-13-005';
import { dispatchTimetableChanges, setN8nDebug } from '../services/n8n.js?v=2026-08-13-005';
...
import '../services/timetable-test-harness.js?v=2026-08-13-005';
