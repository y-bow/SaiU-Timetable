import { CONFIG } from './config.js?v=2026-08-21-006';
import { parseCSV, parseRoomOccupancy, offeringKey } from '../data/parser.js?v=2026-08-21-006';
import { compareTimetables, classIdentity, setChangeDetectorDebug } from '../data/change-detector.js?v=2026-08-21-006';
import { getSection as getStoredSection, setSection as setStoredSection, hasSeenSectionModal, markSectionModalSeen } from '../services/storage.js?v=2026-08-21-006';
import * as nav from '../ui/navigation.js?v=2026-08-21-006';
import * as ui from '../ui/ui.js?v=2026-08-21-006';
import { checkArjunSinghTransition, resetArjunSinghTransition } from '../ui/easter-eggs.js?v=2026-08-21-006';
import * as labSection from '../ui/lab-section.js?v=2026-08-21-006';
import { loadMergedYear2Timetable } from '../services/lab-fetch.js?v=2026-08-21-006';
import { matchesEmergingToolsSection } from '../data/lab-parser.js?v=2026-08-21-006';
import { todayName, nowMinutes, nextSchoolDay, isSchoolDay } from './utils.js?v=2026-08-21-006';
import { init as initAnalytics, trackEvent } from '../services/analytics.js?v=2026-08-21-006';
import { dispatchTimetableChanges, setN8nDebug } from '../services/n8n.js?v=2026-08-21-006';
...
import '../services/timetable-test-harness.js?v=2026-08-21-006';
import { initAiAssistant } from '../ui/ai-assistant.js?v=2026-08-21-006';
import { initFreeRooms } from '../ui/free-rooms.js?v=2026-08-21-006';
